...
module.exports = function(config) {
   ...
   * @see https://developer.foursquare.com/docs/venues/search.html
   */
  function getSuggestioncompletion(lat, lng, query, params, accessToken, callback) {
    logger.debug("ENTERING: Venues.suggestionComplete");
    params = params || {};
    ...
    if(!query) {
      ...
      callback(new Error("Venues.getSuggestioncompletion: query is a required parameter."));
      return;
    }
    params.query = query;
  ...
  return {
    ...
    "getPhotos" : getPhotos,
    "getLinks" : getLinks,
    "getSuggestioncompletion": getSuggestioncompletion
  }
};
